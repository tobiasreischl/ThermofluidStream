...
partial model PartialNTU "Partial heat exchanger model using the epsilon-NTU method"
  ...
  SI.SpecificEnthalpy dh_A "Specific enthalpy difference medium A";
  SI.SpecificEnthalpy dh_B "Specific enthalpy difference medium B";
...
protected
  ...
  SI.AbsolutePressure p_A=MediumA.pressure(inletA.state) "Inlet A pressure";
  SI.AbsolutePressure p_B=MediumB.pressure(inletB.state) "Inlet B pressure";
  ...
  SI.SpecificEnthalpy h_in_A "Specific enthalpy at inlet A";
  SI.SpecificEnthalpy h_in_B "Specific enthalpy at inlet B";
  SI.SpecificEnthalpy h_out_A "Specific enthalpy at outlet A";
  SI.SpecificEnthalpy h_out_B "Specific enthalpy at outlet B";
