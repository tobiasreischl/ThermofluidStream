...
the one the inlet the source is connected to.
  ...
  parameter SI.MassFraction[Medium.nXi] Xi = Medium.X_default[1:Medium.nXi] "Mass fractions set value";
  parameter SI.AbsolutePressure p_0 = Medium.p_default "Initial pressure";

  Interfaces.Rear rear(redeclare package Medium = Medium)
    annotation (Placement(transformation(extent={{-120,-20},{-80,20}})));

protected
  SI.AbsolutePressure p(stateSelect=StateSelect.prefer) "Pressure";
