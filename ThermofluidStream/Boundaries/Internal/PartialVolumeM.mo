...
protected
  ...
  SI.MassFraction Xi_in[Medium.nXi] = if noEvent(m_flow_in >= 0) then Medium.massFraction(inlet.state) else medium.Xi "Inlet mass fractions";
  ...
  SI.MassFraction Xi_out[Medium.nXi,M_outlets] "Mass fractions at outlets";
